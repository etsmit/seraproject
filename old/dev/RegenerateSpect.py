...
#input file
parser.add_argument('-i',dest='infile',type=str,required=True,help='String. Required. Name of input filename. Automatically pulls from in_dir directory. If leading "/" given, pulls from given directory')
