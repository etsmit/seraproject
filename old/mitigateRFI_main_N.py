...
N version that averages every N spectra
...
out_dir = '/data/scratch/SKresults/'#leibniz
...
for block in range(numblocks//mb):
	...
	#put N averaging here?
	#then proceed as normal, just with n=8
	...
	if method == 'stats':
		...
		data = statistical_noise_fir_abs(data,repl_chunk,'/data/scratch/SKresults/absorber_rms/vegas_59934_71648_ABSORBER_0019.0000_rms.npy',block)
